    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
          ...
          BlocProvider(create: (_)=>  PatientBloc(getAllPatientsUseCase: GetAllPatientsUseCase(PatientDataSource()), searchPatientsUseCase: SearchPatientsUseCase(PatientDataSource())),child: PatientsScreen(),)
